...
# 30 "/usr/include/aarch64-linux-gnu/bits/types.h" 3 4
...
# 524 "/usr/include/aarch64-linux-gnu/bits/libio.h" 3 4
}
...
# 1 "/usr/include/aarch64-linux-gnu/c++/7/bits/c++config.h" 1 3
...
# 533 "/usr/include/aarch64-linux-gnu/c++/7/bits/c++config.h" 3
# 1 "/usr/include/aarch64-linux-gnu/c++/7/bits/os_defines.h" 1 3
# 534 "/usr/include/aarch64-linux-gnu/c++/7/bits/c++config.h" 2 3


# 1 "/usr/include/aarch64-linux-gnu/c++/7/bits/cpu_defines.h" 1 3
# 537 "/usr/include/aarch64-linux-gnu/c++/7/bits/c++config.h" 2 3
...
# 207 "/usr/include/aarch64-linux-gnu/bits/floatn-common.h" 3 4
typedef float _Float32;
# 244 "/usr/include/aarch64-linux-gnu/bits/floatn-common.h" 3 4
typedef double _Float64;
# 261 "/usr/include/aarch64-linux-gnu/bits/floatn-common.h" 3 4
typedef double _Float32x;
# 278 "/usr/include/aarch64-linux-gnu/bits/floatn-common.h" 3 4
...
# 246 "/usr/include/aarch64-linux-gnu/sys/types.h" 3 4
...
# 182 "/usr/include/aarch64-linux-gnu/bits/mathcalls.h" 3 4
...
using std::tgamma;
using std::trunc;
# 39 "sw_def_radio.cpp" 2
# 1 "/usr/lib/gcc/aarch64-linux-gnu/7/include/float.h" 1 3 4
# 40 "sw_def_radio.cpp" 2
# 1 "/usr/include/check.h" 1 3 4
# 25 "/usr/include/check.h" 3 4
# 1 "/usr/lib/gcc/aarch64-linux-gnu/7/include/stddef.h" 1 3 4
# 149 "/usr/lib/gcc/aarch64-linux-gnu/7/include/stddef.h" 3 4
typedef long int ptrdiff_t;
# 426 "/usr/lib/gcc/aarch64-linux-gnu/7/include/stddef.h" 3 4
typedef struct {
  long long __max_align_ll __attribute__((__aligned__(__alignof__(long long))));
  long double __max_align_ld __attribute__((__aligned__(__alignof__(long double))));
# 437 "/usr/lib/gcc/aarch64-linux-gnu/7/include/stddef.h" 3 4
} max_align_t;
...
float rxPwrDBM(float PtxdBm, float GtxdB, float GrxdB, float dist, float freq){
  ...
  *pow(10,log10(GrxdB))*(pow(299792458,2))/(pow((4*3.14159265358979323846*(dist*1000)*(freq*1000000000)),2));
...
float getPLF(float phi) {
 phi = phi*(3.14159265358979323846/180);
...
float antGainFromFreq(float efficiency, float aperature_area, float freq){
  float lam = 299792458/freq;

  float antgain = ((10*log10((efficiency*4*3.14159265358979323846*aperature_area)/(lam*lam))));
  printf("Antenna Gain = %f\n\n",antgain);
  return antgain;
}

float getLambda(float freq){
  float clambda = (299792458/freq);

  return clambda;
}

float getFreq(float lam){
  float freq = (299792458/lam);
...
double sqrt(double num){
 ...
 for (i=1; i<=100; i++) {
  x2 = (x1 + num/x1)/2.0;
  if (fabs(x2-x1) < 1.19209289550781250000000000000000000e-7F)
   break;
  x1 = x2;
...
char * floatToStringLB(float f){
 char buffer[1000];
    return gcvt(f,1000,buffer);
}

void storeDataInFileLB(float input){
 FILE * fPtr = fopen("linkBudgetData.txt", "a");
...
void clearDataFromFileLB(){
   FILE * fPtr = fopen("linkBudgetData.txt", "w");
   fclose(fPtr);
}
