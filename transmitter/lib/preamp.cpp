...
PREAMP::PREAMP() {
	...
	PREAMP::freq		= 1.2; 	// Current freq setting of TX Output Amp
	PREAMP::pwr_limit	= 250; 	// Power limit in Watts
	PREAMP::gain		= 20; 	// Output Amp gain in dB
	PREAMP::noise		= -85; 	// Output Amp noise in dB
	PREAMP::zout		= 50;	// Output Impedance, assume 50 Ohms
};

// Parameterized Constructor
PREAMP::PREAMP(struct Preamp pamp) {
	PREAMP::preamp		= pamp;	
	PREAMP::freq		= pamp.freq; 		// Current freq setting of TX Output Amp
	PREAMP::pwr_limit	= pamp.pwr_limit; 	// Power limit in Watts
	PREAMP::gain		= pamp.gain; 		// Output Amp gain in dB
	PREAMP::noise		= pamp.noise; 		// Output Amp noise in dB
	PREAMP::zout		= pamp.zout;		// Output Impedance, assume 50 Ohms	
};
